  ...
  pt: {
    translations: {
      signup: {
        title: "Cadastre-se",
        toasts: {
          success: "Funcionário criado com sucesso! Faça seu login!!!.",
          fail: "Erro ao criar funcionário. Verifique os dados informados.",
        },
        form: {
          name: "Nome",
          email: "Email",
      ...
      transferTicketModal: {
        ...
        fieldLabel: "Digite para buscar funcionários",
        fieldQueueLabel: "Transferir para setor",
        fieldQueuePlaceholder: "Selecione um setor",
        noOptions: "Nenhum funcionário encontrado com esse nome",
        buttons: {
          ok: "Transferir",
          cancel: "Cancelar",
        },
      ...
      users: {
        ...
        confirmationModal: {
          deleteTitle: "Excluir",
          deleteMessage:
            "Todos os dados do funcionário serão perdidos. Os atendimento abertos deste funcionário serão movidos para o setor.",
        },
      },
      helps: {
      ...
      backendErrors: {
        ...
        ERR_USER_CREATION_DISABLED:
          "A criação do funcionário foi desabilitada pelo administrador.",
        ERR_NO_PERMISSION: "Você não tem permissão para acessar este recurso.",
        ERR_DUPLICATED_CONTACT: "Já existe um contato com este número.",
        ERR_NO_SETTING_FOUND: "Nenhuma configuração encontrada com este ID.",
        ERR_NO_CONTACT_FOUND: "Nenhum contato encontrado com este ID.",
        ERR_NO_TICKET_FOUND: "Nenhum atendimento encontrado com este ID.",
        ERR_NO_USER_FOUND: "Nenhum funcionário encontrado com este ID.",
